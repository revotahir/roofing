...
<head>
    <meta charset="utf-8" />
    <title>Add New Clients | Amen Roofing Group</title>
...
<body>
                ...
                <div class="card page-title-box rounded-0">
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                        <div class="flex-grow-1">
                            <h4 class="font-18 fw-semibold mb-0">Ad New Client</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Ad New Client</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="header-title">New Client Form</h5>
                            

                            </div>
                            <div class="card-body pt-2">
                                <form class="form-horizontal parsley-examples" method="post" action="<?=base_url('add-client-data')?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input  id="mPhone" name="mPhone" type="text" class="form-control" placeholder="Enter Phone Number" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div>
    ...
    <?php
    if ($this->session->flashdata('clientAdded') != '') {
    ?>
