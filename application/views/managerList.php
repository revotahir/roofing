...
<head>
    <meta charset="utf-8" />
    <title>Manager List | Amen Roofing Group</title>
...
<body>
                ...
                <div class="card page-title-box rounded-0">
                    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                        <div class="flex-grow-1">
                            <h4 class="font-18 fw-semibold mb-0">Manager List</h4>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['userPhone'] ?></td>
                                                        <td>
                                                            <a href="<?=base_url('edit-manager/'). $row['userID']?>" class=" btn btn-primary" style="float: none;"><i class="mdi mdi-pencil"></i></a>
                                                            <a href="<?= base_url('delete-manger/' . $row['userID']) ?>" onclick="return deleManagerConfimation()" class=" btn btn-danger" style="float: none;"><i class="mdi mdi-delete-empty"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $sr++;
    ...
    ?>
    <?php
    if ($this->session->flashdata('managerUpdated') != '') {
    ?>
        <script type="text/javascript">
            toastr.options = {
                "closeButton": true,
